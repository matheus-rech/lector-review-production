...
function PDFViewerContent({
  ...
  // Handle text selection - create highlight when user selects text
  // Note: This is disabled for now to prevent issues. Will be enabled with proper UI trigger.
  // useEffect(() => {
  ...
  //     const pageNum = currentPageNumber || 1;
  //     
  //     // Call the onAddHighlight callback with the selection
  //     onAddHighlight(rect, pageNum);
  //   }
  // }, [selectionDimensions, currentPageNumber, onAddHighlight]);
